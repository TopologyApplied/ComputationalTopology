...
--ulimit -v unlimited;ulimit -d unlimited; GC_NPROCS=4 GC_MARKERS=4 M2 Koszul6d.m2
t1 = cpuTime()
...
--M0list={}
for i from 3 to 6 do --this is only to verify the code of Koszul12d+8,+9,+10,+11,+12.m2--
(
ofilename=D|"d"|i|"s.txt";
ofile=ofilename<<""<<endl;
M0=R;
