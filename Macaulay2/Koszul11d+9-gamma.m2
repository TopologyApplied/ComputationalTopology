...
--Since the computation for d=1 to 9 is very fast, we directly begin with R/I_{1..9}--
t1 = cpuTime()
...
Ilist={2*t_15*t_17-2*t_16*t_18-2*t_13*t_19+2*t_14*t_20+2*t_11*t_21-2*t_12*t_22-2*t_9*t_23+2*t_10*t_24-2*t_7*t_25+2*t_8*t_26+2*t_5*t_27-2*t_6*t_28-2*t_3*t_29+2*t_4*t_30+2*t_1*t_31-2*t_2*t_32,-2*t_15*t_17-2*t_16*t_18+2*t_13*t_19+2*t_14*t_20-2*t_11*t_21-2*t_12*t_22+2*t_9*t_23+2*t_10*t_24+2*t_7*t_25+2*t_8*t_26-2*t_5*t_27-2*t_6*t_28+2*t_3*t_29+2*t_4*t_30-2*t_1*t_31-2*t_2*t_32,2*t_14*t_17-2*t_13*t_18+2*t_16*t_19-2*t_15*t_20+2*t_10*t_21-2*t_9*t_22+2*t_12*t_23-2*t_11*t_24-2*t_6*t_25+2*t_5*t_26-2*t_8*t_27+2*t_7*t_28-2*t_2*t_29+2*t_1*t_30-2*t_4*t_31+2*t_3*t_32,-2*t_14*t_17+2*t_13*t_18+2*t_16*t_19-2*t_15*t_20-2*t_10*t_21+2*t_9*t_22+2*t_12*t_23-2*t_11*t_24+2*t_6*t_25-2*t_5*t_26-2*t_8*t_27+2*t_7*t_28+2*t_2*t_29-2*t_1*t_30-2*t_4*t_31+2*t_3*t_32,2*t_12*t_17-2*t_11*t_18+2*t_10*t_19-2*t_9*t_20-2*t_16*t_21+2*t_15*t_22-2*t_14*t_23+2*t_13*t_24-2*t_4*t_25+2*t_3*t_26-2*t_2*t_27+2*t_1*t_28+2*t_8*t_29-2*t_7*t_30+2*t_6*t_31-2*t_5*t_32,-2*t_12*t_17+2*t_11*t_18-2*t_10*t_19+2*t_9*t_20-2*t_16*t_21+2*t_15*t_22-2*t_14*t_23+2*t_13*t_24+2*t_4*t_25-2*t_3*t_26+2*t_2*t_27-2*t_1*t_28+2*t_8*t_29-2*t_7*t_30+2*t_6*t_31-2*t_5*t_32,2*t_8*t_17-2*t_7*t_18+2*t_6*t_19-2*t_5*t_20-2*t_4*t_21+2*t_3*t_22-2*t_2*t_23+2*t_1*t_24+2*t_16*t_25-2*t_15*t_26+2*t_14*t_27-2*t_13*t_28-2*t_12*t_29+2*t_11*t_30-2*t_10*t_31+2*t_9*t_32,-2*t_8*t_17+2*t_7*t_18-2*t_6*t_19+2*t_5*t_20+2*t_4*t_21-2*t_3*t_22+2*t_2*t_23-2*t_1*t_24+2*t_16*t_25-2*t_15*t_26+2*t_14*t_27-2*t_13*t_28-2*t_12*t_29+2*t_11*t_30-2*t_10*t_31+2*t_9*t_32,2*t_8*t_9-2*t_7*t_10+2*t_6*t_11-2*t_5*t_12-2*t_4*t_13+2*t_3*t_14-2*t_2*t_15+2*t_1*t_16-2*t_24*t_25+2*t_23*t_26-2*t_22*t_27+2*t_21*t_28+2*t_20*t_29-2*t_19*t_30+2*t_18*t_31-2*t_17*t_32,-2*t_8*t_9+2*t_7*t_10-2*t_6*t_11+2*t_5*t_12+2*t_4*t_13-2*t_3*t_14+2*t_2*t_15-2*t_1*t_16-2*t_24*t_25+2*t_23*t_26-2*t_22*t_27+2*t_21*t_28+2*t_20*t_29-2*t_19*t_30+2*t_18*t_31-2*t_17*t_32,-2*t_16*t_17-2*t_15*t_18+2*t_14*t_19+2*t_13*t_20-2*t_12*t_21-2*t_11*t_22+2*t_10*t_23+2*t_9*t_24+2*t_8*t_25+2*t_7*t_26-2*t_6*t_27-2*t_5*t_28+2*t_4*t_29+2*t_3*t_30-2*t_2*t_31-2*t_1*t_32}
...
isubDim=0;deltas0=0;
I1={};
while isubDim<=9-1 and deltas0==0 do --isubDim<=D-1
(
...
---		M0=M0/I0;--New QuotientRing applied--
		M0=R/I0;--New QuotientRing applied--
